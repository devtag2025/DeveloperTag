                            ...
                            <div className="w-full flex-col justify-center items-start gap-6 flex">
                                <div className="w-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                    <div className="w-full h-full p-3.5 rounded-xl border border-gray-500 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex" data-aos="fade-up">
                                        <h4 className="text-[#4E15BF] text-2xl font-bold font-manrope leading-9">10+</h4>
                                        <p className="text-gray-800 text-base font-normal leading-relaxed">
                                            Year in Business
                                        </p>
                                    </div>
                                    <div className="w-full h-full p-3.5 rounded-xl border border-gray-500 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex" data-aos="fade-up">
                                        <h4 className="text-[#4E15BF] text-2xl font-bold font-manrope leading-9">500+</h4>
                                        <p className="text-gray-800 text-base font-normal leading-relaxed">
                                            Team members
                                        </p>
                                    </div>
                                ...
                                <div className="w-full h-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                    <div className="w-full p-3.5 rounded-xl border border-gray-500 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex" data-aos="fade-up">
                                        <h4 className="text-[#4E15BF] text-2xl font-bold font-manrope leading-9">600+</h4>
                                        <p className="text-gray-800 text-base font-normal leading-relaxed">
                                            International Clients
                                        </p>
                                    </div>
                                    <div className="w-full h-full p-3.5 rounded-xl border border-gray-500 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex" data-aos="fade-up">
                                        <h4 className="text-[#4E15BF] text-2xl font-bold font-manrope leading-9">700+</h4>
                                        <p className="text-gray-800 text-base font-normal leading-relaxed">
                                            Projects Done
                                        </p>
                                    </div>
